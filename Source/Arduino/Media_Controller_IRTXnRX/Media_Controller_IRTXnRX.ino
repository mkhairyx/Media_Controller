/////////////////////////////////////////////////////////////////////////////////
// This code does not have analog battery measurement for the moment.          //
// Analog battery mesurement will be added to the next version of this code.   //
      ...
      while (isnec == 0)
      {
        if (IrReceiver.decode()) {
          if (IrReceiver.decodedIRData.protocol == NEC) {
              ...
              u8g2.clearBuffer();
              u8g2.setFont(u8g2_font_ncenB08_tr);
              u8g2.drawStr(0,10,"Signal recorded and ");
